...
## Highlights
### OpenCV, as a dependency, has been replaced with FFmpeg.
...
### Source Components
1. All [Source components](/docs/api-source.md) (currently video only) have been refactored and extended with an [NVIDIA Video Converter](https://docs.nvidia.com/metropolis/deepstream/dev-guide/text/DS_plugin_gst-nvvideoconvert.html#gst-nvvideoconvert) with new base-class services to get/set the following output buffer properties. (See [#903](https://github.com/prominenceai/deepstream-services-library/issues/903) for more information).
...
4. The [Video Dewarper](/docs/api-dewarper.md) component has been completed and can be added to any Video Source.
5. Multiple instances of [CSI](/docs/api-source.md#dsl_source_csi_new) and [USB](/docs/api-source.md#dsl_source_usb_new) cameras can now be used.
6. A new [Buffer Timeout Pad Probe Handler](/docs/api-pph.md#dsl_pph_buffer_timeout_new) can be added to any Source for notification of new-buffer timeout. 
...
1. New filters have been added to the ODE Triggers - accessible through new services: 
