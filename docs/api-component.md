...
The Pipeline Component API provides the common services that apply to all Pipeline Component types. Many of the services allow multiple Components to be updated simultaneously,  for example [`dsl_component_queue_max_size_set_many`](#dsl_component_queue_max_size_set_many).
...
The Component API services support:
* Component Deletion
* Queue Management
