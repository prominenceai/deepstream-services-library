...
while True:
    ...
    if retval != DSL_RETURN_SUCCESS:
        print(retval)
        break
    dsl_source_uri_new('uri-source-2', "../../test/streams/sample_1080p_h264.mp4", 0, 0, 2)
    dsl_source_uri_new('uri-source-3', "../../test/streams/sample_1080p_h264.mp4", 0, 0, 2)
    dsl_source_uri_new('uri-source-4', "../../test/streams/sample_1080p_h264.mp4", 0, 0, 2)
