...
#    retval = dsl_pipeline_component_add_many('simple-pipeline', ['uri-source', 'primary-gie', 'tiler', 'overlay-sink', None])
    retval = dsl_pipeline_component_add_many('simple-pipeline', ['uri-source-1' , 'tiler', 'overlay-sink', None])
